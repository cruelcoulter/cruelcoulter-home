...
fami<?PHP require 'include_fonts_css.php'; ?>
...
junc_family_member_attachment where family_member_id = :family_member_id and feature_on_detail_page IS NULL)";
...
echo "<a href=\"family_detail.php?family_member_id=" . $row['father_member_id'] .
